namespace MVCConsumeWebAPI.Models
{
   ...
   // public partial class User : IdentityUser   
    public  class User
    {
        ...
        [StringLength(255)]
        [EmailAddress]
        [Remote("doesEmailExist", "User", ErrorMessage = "Ce nom d'utilisateur existe deja, veuillez choisir un autre.")]
        public string email { get; set; }

        [StringLength(255)]
        [Remote("doesLoginExist", "User", ErrorMessage = "Ce nom d'utilisateur existe deja, veuillez choisir un autre.")]
