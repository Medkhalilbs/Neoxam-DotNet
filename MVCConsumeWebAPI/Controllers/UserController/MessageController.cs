...
namespace MVCConsumeWebAPI.Controllers.UserController
{
    public class MessageController : Controller
    {
        ...
        public ActionResult IndexSent()
        {
            ...
            List<message> listeMessages = messageService.GetMany(myMessage => ((myMessage.user_id== JeeUserId) ||(myMessage.destinataire.Equals(userLogin))  ) &&(!myMessage.statusMessage.Equals("archived"))).ToList();
            //List<message> listeMessages = neoxamdbContext.messages.Where(myMessage => ((myMessage.user_id ==    User.Identity.GetJeeUserId())) && (!myMessage.statusMessage.Equals("archived"))).ToList();
            List<Message> listeMessagesModel = new List<Message>();
            ...
            foreach (message msg in listeMessages)
            {
                ...
                msgModel.dateEnvoie = msg.dateEnvoie;
                msgModel.dateLecture = msg.dateLecture;
                msgModel.statusMessage = msg.statusMessage;
                msgModel.destinataire = msg.destinataire;
                msgModel.sujet = msg.sujet;
                msgModel.visibiliteMessage = msg.visibiliteMessage;
                msg.user = msg.user;
        ...
        public ActionResult Details(int id)
        {
            ...
            if (MessageDetails.user.login != login && 
                MessageDetails.dateLecture == null)
        ...
        public ActionResult Create(Message message)
        {
            ...
            string userLogin = User.Identity.Name;
            msg.user_id = User.Identity.GetJeeUserId();
